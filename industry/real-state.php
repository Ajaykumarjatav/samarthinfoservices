...
<section class="hero">
  <div class="container">
    <div class="hero-grid">
      <div class="hero-text">
        <div class="badge">Real Estate Industry</div>
        <h1>Grow Your Real Estate Brand With a Clear and Profitable Marketing System</h1>
        <p>If buyer and seller leads are inconsistent or your ads are not delivering stable results, we help you build a simple, predictable, and scalable marketing system that brings qualified inquiries and long‑term growth.</p>
        <div class="hero-btns">
...
<section class="journey">
  <div class="container">
    <div class="journey-title">
      ...
      <h2 class="section-title">Where Are You in Your Real Estate Growth Journey?</h2>
    </div>
    <div class="journey-grid">
      <div class="journey-card card-active">
        <h3>Launching a New Real Estate Agency or Developer Brand?</h3>
        <p style="font-size:16px; color:#fff; opacity: 60%; margin-bottom:14px;">If you’re building your presence from day one, we help you attract buyers and sellers with the right messaging and channels.</p>
        ...
        <ul class="check-list">
          ...
          <li><i class=""><img src="<?= industry_image_attr('card2.svg') ?>" alt=""></i> High-converting landing pages for listings</li>
          ...
          <li><i class=""><img src="<?= industry_image_attr('card6.svg') ?>" alt=""></i> Launch campaigns for your core projects and listings</li>
      ...
      <div class="journey-card">
        <h3>Already Running an Agency, Brokerage, or Developer Brand?</h3>
        <p style="font-size:16px; color:#000; opacity: 60%; margin-bottom:14px;">If you have traffic but inconsistent closings, we optimize your funnel and campaigns for stable lead growth.</p>
        ...
        <ul class="check-list mobile-icon-height">
          ...
          <li><i class=""><img src="<?= industry_images_attr('tabler-bulb.svg') ?>" alt=""></i>Scaling campaigns by project or locality</li>
          <li><i class=""><img src="<?= industry_images_attr('icon-park-outline-transaction-order.svg') ?>" alt=""></i>Improving cost per lead and site visit rate</li>
...
<section class="services">
  <div class="container">
    <div class="services-header">
      ...
      <p class="section-sub" style="margin-top:8px;">Running ads is easy. Growing a real estate brand profitably is not. We help you build a complete marketing setup that brings the right buyers, converts inquiries, and builds lasting trust.</p>
    </div>
    <div class="services-grid">

      <div class="service-card">
        <div class="icon-box icon-box-teal"><i class="icon_our"><img src="<?= industry_image_attr('logos_meta-icon.svg') ?>" alt=""></i></div>
        <h4>Meta Ads for real estate lead generation</h4>
      ...
      <div class="service-card">
        ...
        <h4>Google Search & Local Ads for property listings</h4>
      ...
      <div class="service-card">
        ...
        <h4>Retargeting & site visit follow-up</h4>
  ...
  <div class="container">
    <div class="hero-grid">
      <div class="hero-text">
        ...
        <h1>Creating a Sustainable Ecosystem for Modern Real Estate Growth</h1>
        <p>Real estate is evolving fast, and buyers have more choices than ever. They compare listings, read reviews, and choose brands they trust. To grow in this environment, you need more than ads — you need a clear marketing system that builds credibility, converts inquiries, and fills your pipeline.

</p>
        <p>We help you create that system so your business can grow consistently with qualified buyer and seller leads.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="struggles">
  <div class="container">
    <div class="str-grid">
      ...
      <div>
        <button class="blue_btn">Our CRO Services</button>
        <h2 class="section-title">The Struggles Every Real Estate <br>Professional Knows</h2>
        <p class="section-sub">Growing a real estate brand today means balancing competition, trust, and rising ad costs. </p>
        <div class="str-list">
          <div class="str-item">
            <i class="vector_icons"><img src="<?= industry_image_attr('Vector (1).svg') ?>" alt=""></i>
            <h5>Ad costs keep rising but closings don’t</h5>
          </div>
          <div class="str-item">
            <i class="vector_icons"><img src="<?= industry_image_attr('Vector (1).svg') ?>" alt=""></i>
          ...
          <div class="str-item">
            <i class="vector_icons"><img src="<?= industry_image_attr('Vector (1).svg') ?>" alt=""></i>
            <h5>No clarity on which channel brings real buyers</h5>
          </div>
          <div class="str-item">
            <i class="vector_icons"><img src="<?= industry_image_attr('Vector (1).svg') ?>" alt=""></i>
...
<section class="why">
  <div class="container">
    <div class="why-header">
      <button class="blue_btn">Our CRO Services</button>
      <h2 class="section-title">Why Choose Us for Real Estate Marketing</h2>
      <p class="section-sub" style="color:#fff; margin:0 auto;">Here’s why real estate brands trust us with their growth:</p>
    </div>
    <div class="why-grid">
      <div class="why-card">
        <div class="icon-box icon-box-teal"><i class=""><img src="<?= industry_image_attr('Vector (3).svg') ?>" alt=""></i></div>
        <h4>We understand how buyers search and choose agents</h4>
        <p>We dive deep into buyer behavior to understand what drives trust, inquiries, and closings.</p>
      </div>
      <div class="why-card">
      ...
      <div class="why-card">
        ...
        <p>We implement strategies designed to attract the right buyers and encourage repeat business.</p>
      </div>
      <div class="why-card">
      ...
      <div class="why-card">
        ...
        <p>We set up automated follow-up systems that nurture leads who didn’t schedule a site visit.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="industries">
  <div class="container">
    ...
    <div class="ind-tags">
      ...
      <div class="ind-tag active"><i class=""><img src="<?= industry_image_attr('realestate.png') ?>" alt=""></i> Real Estate</div>
