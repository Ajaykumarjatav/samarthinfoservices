...
<section class="hero">
  <div class="container">
    <div class="hero-grid">
      <div class="hero-text">
        <div class="badge">Food & Restaurant Industry</div>
        <h1>Grow Your Restaurant Brand With a Clear and Profitable Marketing System</h1>
        <p>If reservations and orders are inconsistent or your ads are not delivering stable results, we help you build a simple, predictable, and scalable marketing system that brings qualified diners and long‑term growth.</p>
        <div class="hero-btns">
...
<section class="journey">
  <div class="container">
    <div class="journey-title">
      ...
      <h2 class="section-title">Where Are You in Your Restaurant Growth Journey?</h2>
    </div>
    <div class="journey-grid">
      <div class="journey-card card-active">
        <h3>Launching a New Restaurant, Café, or Food Brand?</h3>
        <p style="font-size:16px; color:#fff; opacity: 60%; margin-bottom:14px;">If you’re building your presence from day one, we help you attract diners with the right messaging and channels.</p>
        ...
        <ul class="check-list">
          ...
          <li><i class=""><img src="<?= industry_image_attr('card2.svg') ?>" alt=""></i> High-converting landing pages for menus and offers</li>
          ...
          <li><i class=""><img src="<?= industry_image_attr('card6.svg') ?>" alt=""></i> Launch campaigns for your signature dishes and locations</li>
      ...
      <div class="journey-card">
        <h3>Already Running a Restaurant, Café, or Food Chain?</h3>
        <p style="font-size:16px; color:#000; opacity: 60%; margin-bottom:14px;">If you have traffic but inconsistent reservations, we optimize your funnel and campaigns for stable order growth.</p>
        ...
        <ul class="check-list mobile-icon-height">
          ...
          <li><i class=""><img src="<?= industry_images_attr('tabler-bulb.svg') ?>" alt=""></i>Scaling campaigns by location or menu category</li>
          <li><i class=""><img src="<?= industry_images_attr('icon-park-outline-transaction-order.svg') ?>" alt=""></i>Improving cost per lead and reservation rate</li>
...
<section class="services">
  <div class="container">
    <div class="services-header">
      ...
      <p class="section-sub" style="margin-top:8px;">Running ads is easy. Growing a restaurant brand profitably is not. We help you build a complete marketing setup that brings the right diners, converts inquiries, and builds lasting loyalty.</p>
    </div>
    <div class="services-grid">

      <div class="service-card">
        <div class="icon-box icon-box-teal"><i class="icon_our"><img src="<?= industry_image_attr('logos_meta-icon.svg') ?>" alt=""></i></div>
        <h4>Meta Ads for restaurant lead generation</h4>
      ...
      <div class="service-card">
        ...
        <h4>Google Search & Local Ads for restaurants</h4>
      ...
      <div class="service-card">
        ...
        <h4>Retargeting & reservation follow-up</h4>
  ...
  <div class="container">
    <div class="hero-grid">
      <div class="hero-text">
        ...
        <h1>Creating a Sustainable Ecosystem for Modern Restaurant Growth</h1>
        <p>Dining habits are evolving fast, and customers have more choices than ever. They compare menus, read reviews, and choose brands they trust. To grow in this environment, you need more than ads — you need a clear marketing system that builds credibility, converts inquiries, and fills your tables.

</p>
        <p>We help you create that system so your business can grow consistently with qualified reservations and orders.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="struggles">
  <div class="container">
    <div class="str-grid">
      ...
      <div>
        <button class="blue_btn">Our CRO Services</button>
        <h2 class="section-title">The Struggles Every Restaurant <br>Owner Knows</h2>
        <p class="section-sub">Growing a restaurant brand today means balancing competition, reviews, and rising ad costs. </p>
        <div class="str-list">
          <div class="str-item">
            <i class="vector_icons"><img src="<?= industry_image_attr('Vector (1).svg') ?>" alt=""></i>
            <h5>Ad costs keep rising but reservations don’t</h5>
          </div>
          <div class="str-item">
            <i class="vector_icons"><img src="<?= industry_image_attr('Vector (1).svg') ?>" alt=""></i>
          ...
          <div class="str-item">
            <i class="vector_icons"><img src="<?= industry_image_attr('Vector (1).svg') ?>" alt=""></i>
            <h5>Low-quality leads waste staff time</h5>
          </div>
          <div class="str-item">
            <i class="vector_icons"><img src="<?= industry_image_attr('Vector (1).svg') ?>" alt=""></i>
            <h5>No clarity on which channel brings real diners</h5>
          </div>
          <div class="str-item">
            <i class="vector_icons"><img src="<?= industry_image_attr('Vector (1).svg') ?>" alt=""></i>
            <h5>No proper funnel — marketing feels scattered</h5>
          </div>
        </div>
        <div class="btn-cener">
        <a href="#" class="audit_button">Setup Your Business<i class="" style="margin-left:7px;"><img src="<?= industry_image_attr('icon-1.svg') ?>" alt=""></i></a>
...
<section class="real-result real-result-service">
            ...
            <div class="case-study-slider">
                 <div class="slider-box d-flex justify-content-between">
                    <div class="slider-left">
                        ...
                        <p class="case-industry">Industry <strong> Food & Restaurant</strong></p>
                        <div class="d-flex case-flex-first">
                            <p class="case-type">Challenges</p>
                            <p class="case-type-two">Needed more local reservations and orders</p>
                        </div>
        ...
        <div class="slider-box d-flex justify-content-between">
            <div class="slider-left">
                ...
                <p class="case-title">A Multi-Location Restaurant Group</p>
                <p class="case-industry">Industry <strong> Food & Restaurant</strong></p>
                <div class="d-flex case-flex-first">
                    <p class="case-type">Challenges</p>
                    <p class="case-type-two">Struggled with high ad spend & low<br> conversion rates</p>
...
<section class="why">
  <div class="container">
    <div class="why-header">
      <button class="blue_btn">Our CRO Services</button>
      <h2 class="section-title">Why Choose Us for Restaurant Marketing</h2>
      <p class="section-sub" style="color:#fff; margin:0 auto;">Here’s why restaurant brands trust us with their growth:</p>
    </div>
    <div class="why-grid">
      <div class="why-card">
        <div class="icon-box icon-box-teal"><i class=""><img src="<?= industry_image_attr('Vector (3).svg') ?>" alt=""></i></div>
        <h4>We understand how diners search and choose restaurants</h4>
        <p>We dive deep into diner behavior to understand what drives trust, inquiries, and reservations.</p>
      </div>
      <div class="why-card">
      ...
      <div class="why-card">
        ...
        <p>We implement strategies designed to attract the right diners and encourage repeat visits.</p>
      </div>
      <div class="why-card">
...
<section class="industries">
  <div class="container">
    ...
    <div class="ind-tags">
      ...
      <div class="ind-tag active"><i class=""><img src="<?= industry_image_attr('restorent.png') ?>" alt=""></i> Restaurants</div>
